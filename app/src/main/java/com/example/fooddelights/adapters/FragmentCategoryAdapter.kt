...
import com.example.fooddelights.ui.fragments.CategoriesFragment
...
class FragmentCategoryAdapter: RecyclerView.Adapter<FragmentCategoryAdapter.CategoriesViewHolder>() {
    ...
    override fun onBindViewHolder(holder: CategoriesViewHolder, position: Int) {
        ...
        holder.itemView.apply {
            ...
            setOnClickListener {
                val direction = CategoriesFragmentDirections.actionCategoriesFragmentToCategoryFoodItemsFragment(itemCategory)
